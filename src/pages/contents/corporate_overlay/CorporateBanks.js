...
class CorporateBanks extends Component {
  ...
  componentWillMount(){
    ...
    OverlayStore.on('overlay_banks_loaded', this.refresh)
    OverlayStore.on('overlay_branches_loaded', this.refresh)
    OverlayStore.on('overlay_company_detail', this.refresh)
  }

  componentWillUnMount(){
    OverlayStore.removeListener('overlay_banks_loaded', this.refresh)
    OverlayStore.removeListener('overlay_branches_loaded', this.refresh)
    OverlayStore.removeListener('overlay_company_detail', this.refresh)
  ...
  validate(){
    ...
    detail.account_name = OverlayStore.getCompany();
        ...
        <div className={show ?'row wizard-style':'hide'}>
            ...
            <div className="clearfix"></div>
              <div className="overlay-content-style">
                  ...
                  <div className="clearfix"></div>
                  <div className="form-style">
                      <input type="text" className="form-control" value={OverlayStore.getCompany()} onChange={this.onAccountNameChanged.bind(this)} disabled/>
