        ...
        <div className={show ? 'row wizard-style': 'hide'}>
            <div className="col-md-12 review">
                ...
                <div className="overlay-content-style">
                    <div className="col-md-6 col-lg-12 col-xs-12 col-sm-12">
                        
                        <div className="col-md-12 col-lg-12 col-xs-12 col-sm-12 review-label">Account Number</div>
                        <div className="clearfix"></div>
                        <div className="col-md-12 col-lg-12 col-xs-12 col-sm-12 review-value">{account_number}</div>
                        <div className="clearfix"></div>
                        <div className="col-md-12 col-lg-12 col-xs-12 col-sm-12 review-label">Bank</div>
                        <div className="clearfix"></div>
                        <div className="col-md-12 col-lg-12 col-xs-12 col-sm-12 review-value">{primary_bank}, {primary_branch}</div>
                        <div className="clearfix"></div>
                        <div className="col-md-12 col-lg-12 col-xs-12 col-sm-12 review-label">ID Details</div>
                        <div className="clearfix"></div>
                        <div className="col-md-12 col-lg-12 col-xs-12 col-sm-12 review-value">{id_type}, {id_number}</div>
                        <div className="clearfix"></div>
                    </div>
                    <div className="hidden-xs hidden-sm col-md-6 col-lg-12">
                        <div className="col-md-12 col-lg-12 review-label">Approver(s)</div>
                        <div className="clearfix"></div>
                        <div className="col-md-12 col-lg-12 review-value">{approver_name}</div>
                        <div className="clearfix"></div>
                        <div className="col-md-12 col-lg-12 review-label">Approver(s) Mobile</div>
                        <div className="clearfix"></div>
                        <div className="col-md-12 col-lg-12 review-value">{approver_msisdn}</div>
                        <div className="clearfix"></div>
                        <div className="col-md-12 col-lg-12 review-label">Approver(s) Email</div>
                        <div className="clearfix"></div>
                        <div className="col-md-12 col-lg-12 review-value2">{approver_email}</div>
                        <div className="clearfix"></div>
                    </div>
