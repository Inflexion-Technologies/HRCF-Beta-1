            ...
            <div className="col-md-12 review">
                ...
                <div className="overlay-content-style">
                    ...
                    <div className="col-md-6 col-lg-12 col-xs-12 col-sm-12">
                        <div className="col-md-12 col-lg-12 col-xs-12 col-sm-12 review-label">Account Name</div>
                        <div className="clearfix"></div>
                        <div className="col-md-12 col-lg-12 col-xs-12 col-sm-12 review-value">{account_name}</div>
                        <div className="clearfix"></div>
